...
SYR = 2012  # calendar year used to normalize factors
...
Stage_I_factors = Stage_I_factors.drop([2008, 2009, 2010, 2011])
Stage_II_targets = Stage_II_targets.drop([2008, 2009, 2010, 2011])
